...
/**
 * <p>
 * Lazy formatter provides a method to pass on a format string and its
 * parameter objects and delay formatting until the formatter's {@see #toString()}
 * method is called.
 * </p><p>
 * Use with care:
 * There are side effects when the parameter objects are modified after
 * they lazy formatter has been constructed. In this case the 
 * the modified versions of the parameter objects will be used.
 * This can also result in multiple calls to {@see #toString()}
