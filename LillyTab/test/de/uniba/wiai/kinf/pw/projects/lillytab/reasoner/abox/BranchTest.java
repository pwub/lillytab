...
public class BranchTest {
	...
	@Before
	public void setUp() throws ParseException, EReasonerException, ENodeMergeException
	{
		...
		a.getSuccessors().put("r0", b.getNodeID());
		...
		throws EReasonerException, ENodeMergeException
	{
		...
		assertEquals(1, secondBranch.getABox().getNode("a").getSuccessors().size());
		assertTrue(secondBranch.getABox().getNode("a").getSuccessors().containsValue("r0", secondBranch.getABox().getNode("b").getNodeID()));
		assertEquals(1, secondBranch.getABox().getNode("b").getPredecessors().size());
		assertTrue(secondBranch.getABox().getNode("b").getPredecessors().containsValue("r0", secondBranch.getABox().getNode("a").getNodeID()));
