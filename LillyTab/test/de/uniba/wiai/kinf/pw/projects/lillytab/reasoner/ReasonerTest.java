...
public class ReasonerTest
{
		...
		throws ParseException, EReasonerException, EInconsistencyException
	{
		...
		IABoxNode<String, String, String> bNode = _abox.getOrAddNamedNode("b", false);
		aNode.getLinkMap().getAssertedSuccessors().put("r", bNode.getNodeID());
		bNode.getLinkMap().getAssertedSuccessors().put("r", aNode.getNodeID());
...
//			assertEquals(1, aNode.getLinkMap().getAssertedSuccessors().get("r").size());
//			bNode = abox.getNode("b");
//			assertEquals(1, bNode.getLinkMap().getAssertedSuccessors().get("r").size());
//			cNode = abox.getNode("c");
//			assertEquals(1, cNode.getLinkMap().getAssertedSuccessors().get("r").size());
//
//			NodeID blockedNodeID = cNode.getLinkMap().getAssertedSuccessors().get("r").iterator().next();
...
//			assertNull(bNode.getLinkMap().getAssertedSuccessors().get("r"));
...
//			assertEquals(1, bNode.getLinkMap().getAssertedSuccessors().get("r").size());
//			
//			NodeID blockedNodeID = bNode.getLinkMap().getAssertedSuccessors().get("r").iterator().next();
//			IABoxNode<String, String, String> blockedNode = abox.getNode(blockedNodeID);
//			assertNotNull(_reasoner.getBlockingStrategy().getBlocker(blockedNode));
//			assertTrue(_reasoner.getBlockingStrategy().isBlocked(blockedNode));
//		}
...
//			aNode = abox.getNode("a");
//			assertEquals(1, aNode.getLinkMap().getAssertedSuccessors().get("r").size());
//			NodeID blockedNodeID = aNode.getLinkMap().getAssertedSuccessors().get("r").iterator().next();
//			IABoxNode<String, String, String> blockedNode = abox.getNode(blockedNodeID);
...
//	}
		...
		throws ParseException, EReasonerException, EInconsistencyException
	{
		...
		b.getLinkMap().getAssertedSuccessors().put("containedIn", a.getNodeID());
		...
		throws ParseException, EReasonerException, EInconsistencyException
	{
		...
		a0.getLinkMap().getAssertedSuccessors().put("r", b0.getNodeID());
		...
		for (IReasonerResult<String, String, String> result : results) {
			...
			assertEquals(1, abox.getNode("a0").getLinkMap().getAssertedSuccessors().size("r"));
			assertEquals(1, abox.getNode("a0").getLinkMap().getAssertedSuccessors().get("r").size());
			assertEquals(abox.getNode("b").getNodeID(), abox.getNode("a0").getLinkMap().getAssertedSuccessors().get("r").iterator().next());
			assertTrue(abox.getNode("a0").getLinkMap().getAssertedPredecessors().isEmpty());

			assertEquals(1, abox.getNode("a1").getLinkMap().getAssertedSuccessors().size("r"));
			assertEquals(1, abox.getNode("a1").getLinkMap().getAssertedSuccessors().get("r").size());
			assertEquals(abox.getNode("b").getNodeID(), abox.getNode("a1").getLinkMap().getAssertedSuccessors().get("r").iterator().next());
			assertTrue(abox.getNode("a0").getLinkMap().getAssertedPredecessors().isEmpty());

			assertTrue(abox.getNode("b").getLinkMap().getAssertedSuccessors().isEmpty());
			assertEquals(2, abox.getNode("b").getLinkMap().getAssertedPredecessors().size("r"));
			assertTrue(abox.getNode("b").getLinkMap().getAssertedPredecessors().containsValue("r", abox.getNode("a0").getNodeID()));
			assertTrue(abox.getNode("b").getLinkMap().getAssertedPredecessors().containsValue("r", abox.getNode("a1").getNodeID()));
		}
	}
		...
		throws ParseException, EReasonerException, EInconsistencyException
	{
		...
		a.getLinkMap().getAssertedSuccessors().put("r", b.getNodeID());
		...
		for (IReasonerResult<String, String, String> result : results) {
			...
			assertTrue(abox.getNode("a").getLinkMap().getAssertedSuccessors().containsValue("r", abox.getNode("a").getNodeID()));
		}
	}
		...
		throws ParseException, EReasonerException, EInconsistencyException
	{
		...
		a.getLinkMap().getAssertedSuccessors().put("r", b.getNodeID());
		b.getLinkMap().getAssertedSuccessors().put("r", c.getNodeID());
		...
		for (IReasonerResult<String, String, String> result: results) {
			...
			b = abox.getNode("b");
			c = abox.getNode("c");
			assertTrue(a.getLinkMap().getAssertedSuccessors().containsValue("r", c.getNodeID()));
		...
		throws ParseException, EReasonerException, EInconsistencyException
	{
		...
		for (IReasonerResult<String, String, String> result: results) {
			...
			a = abox.getNode("a");
			b = abox.getNode("b");
			assertTrue(a.getLinkMap().getAssertedSuccessors().containsValue("r", b.getNodeID()));
			assertTrue(b.getLinkMap().getAssertedSuccessors().containsValue("r", a.getNodeID()));
		...
		throws ParseException, EReasonerException, EInconsistencyException
	{
		...
		a.getLinkMap().getAssertedSuccessors().put("r", other.getNodeID());
		...
		throws ParseException, EReasonerException, ENodeMergeException, EInconsistencyException
	{
		...
		a.getLinkMap().getAssertedSuccessors().put("r", b.getNodeID());
		a.getLinkMap().getAssertedSuccessors().put("r", c.getNodeID());
		...
		throws ParseException, EReasonerException, EInconsistencyException
	{
		...
		c.getLinkMap().getAssertedSuccessors().put("r", a.getNodeID());
	...
	public void testSubRoleLink() throws EInconsistencyException
	{
		...
		a0.getLinkMap().getAssertedSuccessors().put("sub", a1.getNodeID());
		assertTrue(a0.getLinkMap().hasSuccessor("r", a1));
	}
		...
		throws ENodeMergeException, ParseException, EReasonerException, EInconsistencyException
	{
		...
		assertEquals(1, results.size());
		final IReasonerResult<String, String, String> result = results.iterator().next();
		for (NodeID succID: result.getABox().getNode(a0.getNodeID()).getLinkMap().getSuccessors("sub"))
