...
public class ABoxCloneTest
{
	...
	{
		public List<Pair<IABoxNode<String, String, String>, IABoxNode<String, String, String>>> merges
			= new ArrayList<Pair<IABoxNode<String, String, String>, IABoxNode<String, String, String>>>();
	...
	public void testLinkClone() throws EInconsistentABoxException
	{
		...
		node0.getSuccessors().put("r", node1.getNodeID());
		...
		assertArrayEquals(node0.getSuccessors().values().toArray(), kloneNode0.getSuccessors().values().toArray());
	}
	...
	public void testLinkCloneChange() throws EInconsistentABoxException
	{
		final IABoxNode<String, String, String> node0 = _abox.createNode(false);
		final IABoxNode<String, String, String> node1 = _abox.createNode(false);
		node0.getSuccessors().put("r1", node1.getNodeID());
		
		final IABox<String, String, String> klone = _abox.clone();
		final IABoxNode<String, String, String> kloneNode0 = klone.getNode(node0.getNodeID());
		final IABoxNode<String, String, String> kloneNode1 = klone.getNode(node1.getNodeID());
		kloneNode0.getSuccessors().put("r2", node1.getNodeID());
		
		assertArrayEquals(new Object[]{kloneNode1.getNodeID()}, kloneNode0.getSuccessors().get("r1").toArray());
		assertArrayEquals(new Object[]{kloneNode1.getNodeID()}, kloneNode0.getSuccessors().get("r2").toArray());
	}
	
	@Test
	public void testNodeMergeListenerClone() throws EInconsistentABoxException
	{
	...
	@Test
	public void testNodeMergeListenerCloneChange() throws EInconsistentABoxException
	{
		final IDLNominalReference<String, String, String> a = _aboxFactory.getDLTermFactory().getDLNominalReference("a");
		...
		throws EInconsistentABoxException, ParseException
	{
		...
		assertEquals(1, unfoldListener.unfoldInfos.size());
		assertEquals(A, unfoldListener.unfoldInfos.get(0).initial);
		assertSame(kloneNode0, unfoldListener.unfoldInfos.get(0).node);
		assertArrayEquals(new Object[]{implies.getSuperDescription()}, unfoldListener.unfoldInfos.get(0).unfolds.toArray());		
	}
