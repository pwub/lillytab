...
public class TermEqualityTest {
	...
	public void testIntersectionEquality()
	{
		...
		final Collection<ISWRLAtomicTerm<String, String, String>> terms1 = new ArrayList<ISWRLAtomicTerm<String, String, String>>();
		terms1.add(roleAtom2);
		terms1.add(roleAtom1);
		terms1.add(classAtom1);
		final Collection<ISWRLAtomicTerm<String, String, String>> terms2 = new ArrayList<ISWRLAtomicTerm<String, String, String>>();
