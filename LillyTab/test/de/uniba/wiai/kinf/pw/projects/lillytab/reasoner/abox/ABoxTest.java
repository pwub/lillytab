...
public class ABoxTest
{
		...
		throws EInconsistentABoxException
	{
		...
		node1.getSuccessors().put("r", node2.getNodeID());
		node0.getSuccessors().put("r", node2.getNodeID());
		...
		assertTrue(node0.getSuccessors().containsValue("r", node0.getNodeID()));
		assertTrue(node0.getPredecessors().containsValue("r", node0.getNodeID()));
		assertFalse(node0.getSuccessors().containsValue("r", node2.getNodeID()));

		assertTrue(node1.getSuccessors().containsValue("r", node0.getNodeID()));
		assertTrue(node0.getPredecessors().containsValue("r", node1.getNodeID()));
		assertFalse(node1.getSuccessors().containsValue("r", node2.getNodeID()));
		...
		assertTrue(node0.getSuccessors().containsValue("r", node0.getNodeID()));
		assertTrue(node0.getPredecessors().containsValue("r", node0.getNodeID()));
		assertFalse(node0.getSuccessors().containsValue("r", node1.getNodeID()));
	}
