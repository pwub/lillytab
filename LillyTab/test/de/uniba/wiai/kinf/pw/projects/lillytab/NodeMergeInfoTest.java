...
public class NodeMergeInfoTest
{
	...
	@Before
	public void setUp() throws EInconsistentABoxException, ENodeMergeException
	{
	 ...
	 */
	@Test
	public void testGetCurrentNode() throws EReasonerException, ENodeMergeException
	{
	 ...
	 */
	@Test
	public void testGetModifiedNodesNoModify() throws EReasonerException, ENodeMergeException
	{
		final NodeMergeInfo<String, String, String> mergeInfo = _abox.mergeNodes(_targetNode, _mergedNode);
