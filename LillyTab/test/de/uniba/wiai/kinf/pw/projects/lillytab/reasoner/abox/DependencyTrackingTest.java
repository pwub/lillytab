...
public class DependencyTrackingTest {
	...
	public void testExistsTracking()
		throws EInconsistentABoxException, EReasonerException, ParseException
	{
		...
		throws  EInconsistentABoxException, EReasonerException, ParseException
	{
		...
		final IDLRestriction<String, String, String> andAB = _parser.parse("(and A {b})");
		aNode.addUnfoldedDescription(andAB);
		final Collection<? extends IReasonerResult<String, String, String>> aboxes = _reasoner.checkConsistency(_abox, false);
