...
public class ReasonerDatatypeTest {
	...
	private final IDLTermFactory<OWLObject, OWLClass, OWLProperty<?, ?>> _termFactory = new OWLAPIDLTermFactory(
		_dataFactory);
	private final IABoxFactory<OWLObject, OWLClass, OWLProperty<?, ?>> _aboxFactory = new ABoxFactory<OWLObject, OWLClass, OWLProperty<?, ?>>(
		_termFactory);
	...
	@Test
	public void testSingleDataUnion()
		throws OWLOntologyCreationException, OWLOntologyChangeException, EInconsistencyException
	{
		/* regression test */
