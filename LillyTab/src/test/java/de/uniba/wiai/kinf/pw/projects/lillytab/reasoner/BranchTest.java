...
public class BranchTest {
		...
		throws EReasonerException, EInconsistencyException
	{
		...
		assertTrue(secondBranch.getABox().getNode("a").getRABox().getAssertedSuccessors().containsValue("r0",
																										secondBranch.getABox().getNode(
			"b").getNodeID()));
		assertEquals(1, secondBranch.getABox().getNode("b").getRABox().getAssertedPredecessors().size());
		assertTrue(secondBranch.getABox().getNode("b").getRABox().getAssertedPredecessors().containsValue("r0",
																										  secondBranch.getABox().getNode(
			"a").getNodeID()));
