...
/**
 * <p> {@link IABoxNode}s are the representation of individuals in a description logic tableaux.
 * </p><p>
 ...
 * </p><p>If a node is named, one of the names is the <emph>primary name</emph>
...
public interface IABoxNode<Name extends Comparable<? super Name>, Klass extends Comparable<? super Klass>, Role extends Comparable<? super Role>>
	...
	/**
	 * <p>Get a collection of {@link TermEntry} representing the terms from the node's term set.
	 *
	 * @see #getTerms()
