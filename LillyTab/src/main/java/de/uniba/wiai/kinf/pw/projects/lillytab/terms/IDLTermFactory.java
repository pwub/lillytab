...
public interface IDLTermFactory<Name extends Comparable<? super Name>, Klass extends Comparable<? super Klass>, Role extends Comparable<? super Role>> {
	...
	IDLIntersection<Name, Klass, Role> getDLIntersection(IDLRestriction<Name, Klass, Role> d0,
														 IDLRestriction<Name, Klass, Role> d1);
	...
	IDLImplies<Name, Klass, Role> getDLImplies(IDLRestriction<Name, Klass, Role> sub,
											   IDLRestriction<Name, Klass, Role> sup);
