...
public class ImmutableABox<I extends Comparable<? super I>, L extends Comparable<? super L>, K extends Comparable<? super K>, R extends Comparable<? super R>>
	implements IABox<I, L, K, R>, IDecorator<IABox<I, L, K, R>> {
	...
	{
		if (_deepHashCode == 0) {
			_deepHashCode = _baseABox.deepHashCode();
		}
	...
	@Override
	public IDatatypeABoxNode<I, L, K, R> createDatatypeNode(boolean isSynthetic) throws ENodeMergeException
	{
		throw new UnsupportedOperationException("Cannot modify ImmutableABox.");
	}

	@Override
	public IIndividualABoxNode<I, L, K, R> createIndividualNode(boolean isSynthetic) throws ENodeMergeException
	{
		throw new UnsupportedOperationException("Cannot modify ImmutableABox.");
	}

	@Override
	public IABoxNode<I, L, K, R> createNode(boolean isDatatypeNode, boolean isSynthetic) throws ENodeMergeException
	{
		throw new UnsupportedOperationException("Cannot modify ImmutableABox.");
	}
	...
	@Override
	public boolean isSynthetic(IABoxNode<I, L, K, R> node)
	{
		return _baseABox.isSynthetic(node);
	}

	@Override
	public boolean isSynthetic(NodeID nodeID)
	{
		return _baseABox.isSynthetic(nodeID);
	}
	...
	public boolean equals(Object obj)
	{
		if (this == obj) {
			return true;
		} else if (obj instanceof ImmutableABox) {
			final ImmutableABox<?, ?, ?, ?> other = (ImmutableABox<?, ?, ?, ?>) obj;
	...
	public int hashCode()
	{
		return _baseABox.hashCode();
	}

	@Override
	public IABox<I, L, K, R> getDecoratee()
	{
		return _baseABox;
	}
