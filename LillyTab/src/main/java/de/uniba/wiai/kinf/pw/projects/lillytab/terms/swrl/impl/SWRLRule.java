...
public class SWRLRule<Name extends Comparable<? super Name>, Klass extends Comparable<? super Klass>, Role extends Comparable<? super Role>>
	...
	private final Set<ISWRLVariable<Name, Klass, Role>> _variables = new TreeSet<>();
...
//		}
	...
	private static <Name extends Comparable<? super Name>, Klass extends Comparable<? super Klass>, Role extends Comparable<? super Role>> Set<String> extractVariableNames(
		ISWRLTerm<Name, Klass, Role> term)
	{
	...
	private static <Name extends Comparable<? super Name>, Klass extends Comparable<? super Klass>, Role extends Comparable<? super Role>> Set<String> extractVariableNames(
		ISWRLTerm<Name, Klass, Role> term, Set<String> varNames)
	{
	...
	private static <Name extends Comparable<? super Name>, Klass extends Comparable<? super Klass>, Role extends Comparable<? super Role>> Set<ISWRLVariable<Name, Klass, Role>> extractVariables(
		ISWRLTerm<Name, Klass, Role> term)
	{
		Set<ISWRLVariable<Name, Klass, Role>> varNames = new TreeSet<>();
	...
	@SuppressWarnings("unchecked")
	private static <Name extends Comparable<? super Name>, Klass extends Comparable<? super Klass>, Role extends Comparable<? super Role>> Set<ISWRLVariable<Name, Klass, Role>> extractVariables(
		ISWRLTerm<Name, Klass, Role> term, Set<ISWRLVariable<Name, Klass, Role>> vars)
	{
		if (term instanceof ITermList) {
	...
	@Override
	public int compareTo(ISWRLRule<Name, Klass, Role> o)
	{
