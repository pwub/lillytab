...
public interface IABox<Name extends Comparable<? super Name>, Klass extends Comparable<? super Klass>, Role extends Comparable<? super Role>>
	...
	/**
	 * <p> Create a new, anonymous nodeand add it to the current ABox. </p><p>
	 * Note, that this does NOT unfold global descriptions onto the newly created node. </p><p> The {
	 *
