 ...
 * blocking.
 * </p><p> {@link IBlockingStrategy} encapsulates the interface to a pluggable blocking strategy.
 * </p>
 *
...
public interface IBlockingStrategy<Name extends Comparable<? super Name>, Klass extends Comparable<? super Klass>, Role extends Comparable<? super Role>> {
	...
	/**
	 * <p> @return The blocker of the target node or {@literal null} if the current node is not known to be blocked.
	 * </p><p>
	 * Blocking nodes must be searched inside the ABox. Since this is often a computationally intesive task, blocking
	 * status may be cached internally. Changes to the ABox that potentially invalidate the blocking condition must call {@link #validateBlocks()
	 * } afterwards.
