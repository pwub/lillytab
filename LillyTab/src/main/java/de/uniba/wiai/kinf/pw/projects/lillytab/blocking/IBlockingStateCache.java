...
public interface IBlockingStateCache
	 ...
	 */
	<Name extends Comparable<? super Name>, Klass extends Comparable<? super Klass>, Role extends Comparable<? super Role>> IABoxNode<Name, Klass, Role> getBlocker(
		final IABoxNode<Name, Klass, Role> blockedNode);
