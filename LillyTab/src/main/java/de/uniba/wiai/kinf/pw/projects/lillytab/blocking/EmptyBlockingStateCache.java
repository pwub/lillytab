...
public class EmptyBlockingStateCache
	...
	public <Name extends Comparable<? super Name>, Klass extends Comparable<? super Klass>, Role extends Comparable<? super Role>> IABoxNode<Name, Klass, Role> getBlocker(
		IABoxNode<Name, Klass, Role> blockedNode)
	{
		return null;
	}
