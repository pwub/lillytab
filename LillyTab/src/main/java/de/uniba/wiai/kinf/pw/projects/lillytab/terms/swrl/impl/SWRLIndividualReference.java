	...
	implements ISWRLIndividualReference<I, L, K, R>
{
	...
	{
		if (o instanceof ISWRLIndividualReference) {
			final ISWRLIndividualReference<I, L, K, R> other = (ISWRLIndividualReference<I, L, K, R>) o;
			return _individual.compareTo(other.getIndividual());
	...
	public boolean equals(Object obj)
	{
		...
		if (obj instanceof ISWRLIndividualReference) {
			...
			return _individual.equals(other.getIndividual());
		} else {
			return false;
		}
	}
