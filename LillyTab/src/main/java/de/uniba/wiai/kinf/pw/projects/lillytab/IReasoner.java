...
public interface IReasoner<Name extends Comparable<? super Name>, Klass extends Comparable<? super Klass>, Role extends Comparable<? super Role>> {
	 ...
	 * Determine, if presumedSub is a subclass of presumedSuper with regard to the given ABox.
	 * </p><p>
	 * This is <convenience method for {@link #isSubClassOf(IABox, IDLRestriction, IDLRestriction)}. </p> @param abox
	 * The abox to use as background knowledge @param presumedSub The p
	 *
	 *
	 *
	 *
	...
	public boolean isSubClassOf(
		final IABox<Name, Klass, Role> abox,
		final Klass presumedSub,
		final Klass presumedSuper)
		throws EReasonerException, EInconsistencyException;
	 ...
	 *
	 */
	public boolean isDisjoint(final IABox<Name, Klass, Role> abox, final IDLRestriction<Name, Klass, Role> desc1,
	 ...
	 *
	 */
	public Collection<IDLImplies<Name, Klass, Role>> classify(final IABox<Name, Klass, Role> abox)
		throws EReasonerException, EInconsistencyException;
}
