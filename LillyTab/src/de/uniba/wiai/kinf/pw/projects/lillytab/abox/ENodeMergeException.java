	...
	extends EInconsistentABoxException
{
	...
	/**
	 * Creates a new instance of <code>ENodeMergeException</code> without detail message.
	 */
	...
	/**
	 * Constructs an instance of <code>ENodeMergeException</code> with the specified detail message.
