	...
	implements IDLIntersection<Name, Klass, Role>
{
	...
	public boolean equals(Object obj)
	{
		if (this == obj)
			...
			/* intersection is a commutative operation, this equality needs to be as well */
	...
	{
		return new DLDummyDescription<Name, Klass, Role>(DLTermOrder.DL_BEFORE_INTERSECTION);
	}

	public IDLRestriction<Name, Klass, Role> getAfter()
	{
		return new DLDummyDescription<Name, Klass, Role>(DLTermOrder.DL_AFTER_INTERSECTION);
	}
