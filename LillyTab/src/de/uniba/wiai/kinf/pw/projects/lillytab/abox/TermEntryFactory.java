...
{
	private final WeakHashMap<TermEntry<Name, Klass, Role>, WeakReference<TermEntry<Name, Klass, Role>>> _termCache = new WeakHashMap<TermEntry<Name, Klass, Role>, WeakReference<TermEntry<Name, Klass, Role>>>();
	
	public TermEntryFactory()
	{
	}
	
	public TermEntry<Name, Klass, Role> getEntry(final IABoxNode<Name, Klass, Role> node, final IDLTerm<Name, Klass, Role> term)
	{
