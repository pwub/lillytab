...
/**
 * An implementation of equality blocking.
 * This is the same as {@link SubsetBlockingStrategy} but 
 * the set of concept terms must be strictly equal (not subsets).
 *
...
public class EqualityBlockingStrategy<Name extends Comparable<? super Name>, Klass extends Comparable<? super Klass>, Role extends Comparable<? super Role>>
	 ...
	 * is a equal to ours and if we are (strictly) in front of
