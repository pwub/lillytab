...
public interface ICompleter<Name extends Comparable<? super Name>, Klass extends Comparable<? super Klass>, Role extends Comparable<? super Role>> {
	...
	/**
	 * <p> Apply completion rules to the specified {@literal node}. </p><p> Should return {@literal true}, if further
	 * completion rules may be applied to the current node or {@literal false}, if the completion needs to recheck the
	 * branch queue and node queue (and possible continue completion of a different node and/or branch). </p>
	 *
