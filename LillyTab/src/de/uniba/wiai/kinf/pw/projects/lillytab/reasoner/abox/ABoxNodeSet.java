	...
	extends AspectSortedSet<IABoxNode<Name, Klass, Role>>
{
	...
	{
		return new ABoxNodeSet<Name, Klass, Role>(newABox, this);
	}

	/**
	 * <p>
	 * Remove the {@literal node} from the node set,
	 * but to not remove its links to other nodes.
	 * </p><p>
	 * The backlink from the node to the Abox is kept.
	 * The node map and set are updated, however.
	 * </p>
	 * @param node
	 * @return 
	 * 
