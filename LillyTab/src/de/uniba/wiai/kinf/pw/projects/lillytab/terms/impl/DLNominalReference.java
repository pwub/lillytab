	...
	implements IDLNominalReference<Name, Klass, Role>
{
	...
	{
		return new DLDummyDescription<Name, Klass, Role>(DLTermOrder.DL_BEFORE_NOMINAL_REFERENCE);
	}

	public IDLRestriction<Name, Klass, Role> getAfter()
	{
		return new DLDummyDescription<Name, Klass, Role>(DLTermOrder.DL_AFTER_NOMINAL_REFERENCE);
	}
}
