...
/**
 * <p>
 *  Basic implmementation {@link ITerm} list with a fixed
 *  number of subterms.
 * </p>
 *
	...
	implements ITermList<Term>
{
	...
	/**
	 * <p>
	 * Construct a new {@link AbstractFixedTermList} using
	 * {@literal backend} as the backend list.
	 * </p><p>
	 * {@literal backend} Must already be of the desired size.
	 * </p>
	 *
	...
	/**
	 * <p>
	 *   Construct a new {@link AbstractFixedTermList} using an
	 *   {@link ArrayList} for backend storage. The list will
	 *   be filled with {@literal null}s up to the desired number
	 *   of elements.
	 * </p>
	...
	public boolean equals(final Object obj)
	{
		if (this == obj)
			return true;
		/* avoid warning */
		assert obj instanceof ITermList;
	...
	/**
	 * <p>
	 * Compare the the {@link ITermList} {@literal tl0} to the object
	 * {@literal o1}.
	 * </p>
	 *
