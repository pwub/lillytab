...
public class EInvalidTermException extends RuntimeException {
    ...
    /**
     * Creates a new instance of <code>EInvalidTermException</code> without detail message.
     */
    ...
    /**
     * Constructs an instance of <code>EInvalidTermException</code> with the specified detail message.
	...
	/**
	 * Constructs an instance of  <code>EInvalidTermException$</code> with the specified
	 * detail message and wrapping an inner exception.
	 *
	...
	/**
	 * Constructs an instance of <code>EInvalidTermException$</code>
