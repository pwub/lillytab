...
/**
 * Wrapper class combining a {@link NodeID} with a 
 * {@link IDLTerm}. This is mostly useful for dependency tracking.
 *
	...
	implements Serializable, Comparable<TermEntry<Name, Klass, Role>>
{
	...
	protected static <Name extends Comparable<? super Name>, Klass extends Comparable<? super Klass>, Role extends Comparable<? super Role>>
		TermEntry<Name, Klass, Role>
		wrap(final NodeID nodeID, final IDLTerm<Name, Klass, Role> term)
	{
		return new TermEntry<Name, Klass, Role>(nodeID, term);
	}

	protected static <Name extends Comparable<? super Name>, Klass extends Comparable<? super Klass>, Role extends Comparable<? super Role>>
		TermEntry<Name, Klass, Role>
		wrap(final IABoxNode<?, ?, ?> node, final IDLTerm<Name, Klass, Role> term)
	{
