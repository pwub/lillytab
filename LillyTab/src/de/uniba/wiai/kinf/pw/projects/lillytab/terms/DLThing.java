 ...
 */
public class DLThing<Name extends Comparable<? super Name>, Klass extends Comparable<? super Klass>, Role extends Comparable<? super Role>>
	implements IDLRestriction<Name, Klass, Role>, IAtom
{
	...
	{
		/* DLThing is a singleton, order is only dependent on term order */
	...
	{
		return new DLDummyDescription<Name, Klass, Role>(DLTermOrder.DL_BEFORE_THING);
	}

	public IDLRestriction<Name, Klass, Role> getAfter()
	{
		return new DLDummyDescription<Name, Klass, Role>(DLTermOrder.DL_AFTER_THING);
	}
