	...
	extends EInconsistentABoxNodeException
{
    ...
    /**
     * Creates a new instance of <code>EInconsistentABoxNodeException</code> without detail message.
     */
    ...
    /**
     * Constructs an instance of <code>EInconsistentABoxNodeException</code> with the specified detail message.
     * @param msg the detail message.
     */
    public EIncompatibleABoxNodesException(final IABoxNode<?, ?, ?> node, final IABoxNode<?, ?, ?> otherNode, final String msg) {
        super(node, msg);
		_otherNode = otherNode;
    }
