	...
	implements IDecorator<M>, Map<K, V>
{
	...
	private final CopyOnWriteMapEntrySet<K, V, M> _entrySet = new CopyOnWriteMapEntrySet<>(this);
	private final CopyOnWriteMapKeySet<K, V, M> _keySet = new CopyOnWriteMapKeySet<>(this);
	private final CopyOnWriteMapValueCollection<K, V, M> _valueCollection = new CopyOnWriteMapValueCollection<>(
		this);
