 ...
 */
public class GenericCopyOnWriteCollection<E, C extends Collection<E>>
	implements Collection<E>, IDecorator<C>
{
	private final ICollectionFactory<E, C> _factory;
	private C _wrappedCollection;
	...
	protected GenericCopyOnWriteCollection(final C initialCollection, final ICollectionFactory<E, C> factory)
	{
	...
	{
		if (!_wasCopied) {
			C newCollection = _factory.getInstance();
	 ...
	 * @return the _factory
	 */
	protected ICollectionFactory<E, C> getFactory()
	{
		return _factory;
	}
}
