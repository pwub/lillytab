	...
	implements SortedSet<E>
{
	...
	{
		return new CopyOnWriteSortedSubSet<E, S>(this, fromElement, toElement);
	}

	public SortedSet<E> headSet(final E toElement)
	{
		return new CopyOnWriteSortedSubSet<E, S>(this, null, toElement);
	}

	public SortedSet<E> tailSet(final E fromElement)
	{
		return new CopyOnWriteSortedSubSet<E, S>(this, fromElement, null);
	}
