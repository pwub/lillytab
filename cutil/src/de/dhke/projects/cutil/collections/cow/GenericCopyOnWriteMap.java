 ...
 */
public class GenericCopyOnWriteMap<K, V, M extends Map<K, V>>
	implements IDecorator<M>, Map<K, V>
{
	/***************************************************************************************************************
	 *
	 * GenericCopyOnWriteMap
	 *
	 ***************************************************************************************************************/
	private M _wrappedMap;
	private final IMapFactory<K, V, M> _factory;
	private boolean _wasCopied;
	private final CopyOnWriteMapEntrySet<K, V, M> _entrySet = new CopyOnWriteMapEntrySet<K, V, M>(this);
	private final CopyOnWriteMapKeySet<K, V, M> _keySet = new CopyOnWriteMapKeySet<K, V, M>(this);
	private final CopyOnWriteMapValueCollection<K, V, M> _valueCollection = new CopyOnWriteMapValueCollection<K, V, M>(
		this);

	protected GenericCopyOnWriteMap(final M wrappedMap, final IMapFactory<K, V, M> factory)
	{
	 ...
	 * @return the _factory
	 */
	protected IMapFactory<K, V, M> getFactory()
	{
		return _factory;
	}
}
