 ...
 */
public class TreeSortedSetFactory<E>
	implements ICollectionFactory<E, SortedSet<E>>
{
	private final Comparator<? super E> _comparator;

	public TreeSortedSetFactory(final Comparator<? super E> comparator)
	{
		_comparator = comparator;
	}

	public TreeSortedSetFactory()
	{
		_comparator = null;
	}
	...
	public SortedSet<E> getInstance(final SortedSet<E> baseCollection)
	{
		if (_comparator == null)
			return new TreeSet<E>(baseCollection);
		else {
			SortedSet<E> treeSet = getInstance();
