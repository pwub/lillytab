	...
	implements Set<Map.Entry<K, V>>, IDecorator<Set<Map.Entry<K, V>>>
{
	...
	{
		return new ImmutableEntrySet<K, V>(backEntrySet, null, null);
	}
	...
	{
		return new ImmutableEntrySet<K, V>(backEntrySet, null, valueTransformer);
	}
	...
	{
		return new ImmutableEntrySet<K, V>(backEntrySet, keyTransformer, valueTransformer);
	}
