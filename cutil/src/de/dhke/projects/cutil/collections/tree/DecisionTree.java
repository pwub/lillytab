...
public class DecisionTree<Data>
	...
	class Itr
		...
		private final Stack<Iterator<? extends Node<Data>>> iterStack = new Stack<Iterator<? extends Node<Data>>>();
	...
	{
		final List<Node<Data>> path = new ArrayList<Node<Data>>();
	...
	class DTNode
		...
		public DTNode(final DTNode newParent)
		{
			_parent = newParent;
			_children = SetUniqueList.decorate(new ArrayList<DTNode>());
		}

		public DTNode(final DTNode newParent, final Data data)
		{
			_parent = newParent;
			_data = data;
			_children = SetUniqueList.decorate(new ArrayList<DTNode>());
